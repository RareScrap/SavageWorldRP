            ...
            for (Object playerEntity : sender.getEntityWorld().playerEntities) {
                if (((EntityPlayer) playerEntity).getDisplayName().equals(argString[0])) {
                    ...
                    CommonProxy.INSTANCE.sendTo(new PacketCommandReponse(PARAMS_MESSAGE_LOCALE_KEY, 200,
                            ...
                            String.valueOf(ExtendedPlayer.get((EntityPlayer) playerEntity).getParamWithModifiers(ExtendedPlayer.ParamKeys.STEP)),
                            String.valueOf(ExtendedPlayer.get((EntityPlayer) playerEntity).getParamWithModifiers(ExtendedPlayer.ParamKeys.PROTECTION)),
                            String.valueOf(ExtendedPlayer.get((EntityPlayer) playerEntity).getParamWithModifiers(ExtendedPlayer.ParamKeys.PERSISTENCE)),
                            String.valueOf(ExtendedPlayer.get((EntityPlayer) playerEntity).getParamWithModifiers(ExtendedPlayer.ParamKeys.CHARISMA)),
